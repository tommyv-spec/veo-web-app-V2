...
def init_db(database_url: str = None):
    ...
    if is_sqlite:
        ...
        # PostgreSQL connection pooling - increased for concurrent workloads
        engine_kwargs["pool_size"] = 10  # Increased from 5
        engine_kwargs["max_overflow"] = 20  # Increased from 10
        ...
        engine_kwargs["pool_timeout"] = 10  # Wait max 10s for connection (was 30s default)
